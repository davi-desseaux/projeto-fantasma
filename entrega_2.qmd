...
A @tbl-tabela_pearson mostra os resultados. A correlação de Pearson indicou que há evidência estatisticamente significativa de que existe uma correlação linear entre peso e altura (ρ≈0.697), mais especificamente, uma correlação forte a moderada. Em resumo, a medida que a altura cresce, o peso tende a crescer (e vice-versa). O inverso também acontece, a medida que o cliente é mais baixo, o peso tende de maneira moderada a forte ser mais baixo também. 
